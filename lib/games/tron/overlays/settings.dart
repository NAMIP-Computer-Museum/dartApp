            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: HorizontalPicker(
                          data: difficulties.map((e) => e.tr).toList(),
                  ...
                  Row(
                    children: [
                      Text("${"taille_grille".tr}:", style: const TextStyle(color: Colors.white, fontSize: 17)),
                      Expanded(
                        child: HorizontalPicker(
                          data: gridSizes,
                  ...
                  Row(
                    children: [
                      Text("${"nombre_joueurs".tr} :", style: const TextStyle(color: Colors.white, fontSize: 17)),
                      Expanded(
                        child: HorizontalPicker(
                          data: const [1, 2, 3],
