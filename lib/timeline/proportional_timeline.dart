...
class _ProportionalTimelineState extends State<ProportionalTimeline> {
  ...
  late int beginYear = componentsSelected.first.date;
  late int endYear = componentsSelected.last.date;
                  ...
                  children: [
                    DropdownButton(
                      ...
                      items: [
                        ...
                        DropdownMenuItem(
                          value: 'Phase 1',
                          child: Text('phase1'.tr,
                              style: const TextStyle(color: Colors.green)),
                        ),
                        DropdownMenuItem(
                          value: 'Phase 2',
                          child: Text('phase2'.tr,
                              style: const TextStyle(color: Colors.pink)),
                        ),
                        DropdownMenuItem(
                          value: 'Phase 3',
                          child: Text('phase3'.tr,
  ...
  Widget timelineTile(
      List<Component> components, bool isFirst, bool isLast, int date) {
                              ...
                              Builder(
                                builder: (context) {
                                  ...
                                  if (component.name.length > 12) {
                                    text = "${component.name.substring(0, 10)}...";
                                  }
                                  return Text(text,
                                      style: const TextStyle(
                                          fontSize: 20,
